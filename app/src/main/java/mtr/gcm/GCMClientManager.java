...
/**
 * Created by Saurabh on 3/3/2015.
 */
...
//        }
    ...
    public void registerIfNeeded(final RegistrationCompletedHandler handler) {
        if (checkPlayServices()) {
            CommonUtil prefUtil = new CommonUtil(getContext());
            regid = prefUtil.getRegistrationId();

            if (regid.isEmpty()) {
                registerInBackground(handler);
            } else { // got id from cache
                Log.i(TAG, regid);
                /*pref.edit().putString(DEVICE_TOKEN, regid).commit();*/
            ...
            protected String doInBackground(Void... params) {
                try {
                   ...
                   /* pref.edit().putString(DEVICE_TOKEN, regid).commit();*/
                    ...
                    CommonUtil prefUtil = new CommonUtil(getContext());
                    prefUtil.storeRegistrationId(regid);
